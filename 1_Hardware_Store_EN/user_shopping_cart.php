...
<html lang="en">
    <head>
        ...
        ?>
        <title>Hardware store Juarez - Cart</title>
    </head>
    <body>
        <?php
                ...
                while($row = mysqli_fetch_object($data)){
                    ...
                    <form class="form-delete" name="form_delete" method="get" action="user_delete_shoppingCart.php" target="_self">
                        ...
                        <button id="delete" class="button-product-delete" type="submit" name="button_product_delete" value="">
                            <img class="icon" src="icons/delete.svg" alt="delete_cart" title="Remove from the cart">
                        </button>
                    </form>
                    <form id="form_cart" class="form-product" name="form-data-materials" method="get" action="user_add_shoppingCart.php" target="_self">
                        ...
                        <button id="edit" class="button-product" type="submit" name="button_product_edit" value="">
                            <img class="icon" src="icons/edit.svg" alt="edit_cart" title="Edit purchase">
                        </button>
                    </form>
                    <?php
                }
            }else{
                echo '<h1 style="text-align: center; font-size: 70px">No products in your cart</h1>';
            }
            ?>
            <form style="text-align: center" action="buy_products.php" target="_self">
                <button style="font-size: 3em; border-radius: 10px" id="edit" class="button-product" type="submit" name="button_product_edit" value="">Purchase</button>
            </form>
        </main>
        <?php
